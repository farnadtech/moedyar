          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <h4 className="font-medium text-yellow-900 mb-2">
                      ⚠️ وضعیت فعلی: حالت دمو
                    </h4>
                    <p className="text-yellow-700 text-sm">
                      در حال حاضر سیستم فقط لاگ می‌کند و ایمیل واقعی ارسال
                      نمی‌کند
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <ol className="space-y-2 text-sm list-decimal list-inside">
                      <li>
                        یک حساب Gmail ایجاد کنید یا از حساب موجود استفاده کنید
                      </li>
                    ...
                    <div className="mt-3 text-xs text-gray-600">
                      💡 راهنمای کامل ایجاد App Password در{" "}
                      <a
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>تنظیمات نهایی برای راه‌اندازی</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
