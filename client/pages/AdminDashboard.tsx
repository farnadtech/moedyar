...
export default function AdminDashboard() {
  ...
  const loadAdminData = async () => {
    try {
      ...
      const [statsResponse, usersResponse, activitiesResponse] =
        await Promise.all([
  ...
  const handleUserAction = async (
    ...
    try {
      if (action === "delete") {
        ...
        const response = await apiService.updateUserSubscription(
          userId,
          newSubscription,
        );
        if (response.success) {
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  رایگان: {stats.users.free} | پرمیوم: {stats.users.premium} |
                  کسب‌وکار: {stats.users.business}
                </p>
              </CardContent>
            </Card>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <select
                          ...
                          onChange={(e) =>
                            handleUserAction("upgrade", user.id, e.target.value)
                          }
